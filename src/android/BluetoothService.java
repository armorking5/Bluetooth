...
public class BluetoothService {
    ...
    private static final String NAME_SECURE = "PhoneGapBluetoothServiceSecure";
    private static final String NAME_INSECURE = "PhoneGapBluetoothServiceInSecure";

    // Unique UUID for this application
    private static final UUID MY_UUID_SECURE = UUID.fromString("0870842a-be91-4bf1-97d0-fbdca05155d8");
    private static final UUID MY_UUID_INSECURE = UUID.fromString("bbd40669-a93c-4ff3-96fd-c8975c0735a9");
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Bluetooth.TOAST, "Unable to connect to device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Bluetooth.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
